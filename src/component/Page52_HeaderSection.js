...
const Page52_HeaderSection = ({ year, setYear, month, setMonth, day, setDay, weekDay, setWeekDay, weather, setWeather }) => {
  const weatherIcons = [
    { id: "sun", source: require("../../assets/sun.png") },
    { id: "cloud", source: require("../../assets/cloud.png") },
    { id: "rain", source: require("../../assets/rain.png") },
    { id: "snow", source: require("../../assets/snow.png") },
  ];

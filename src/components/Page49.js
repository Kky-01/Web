...
const Page49 = () => {
  ...
  const foodImages = [
    { source: require('../assets/image/food01.jpg'), name: '콩밥', kcal: '354kcal', weight: '210g' },
    { source: require('../assets/image/food02.jpg'), name: '보리밥', kcal: '294kcal', weight: '210g' },
    { source: require('../assets/image/food03.jpg'), name: '쌀밥', kcal: '313kcal', weight: '210g' },
    { source: require('../assets/image/food04.jpg'), name: '갓김치', kcal: '25kcal', weight: '60g' },
    { source: require('../assets/image/food05.jpg'), name: '미역초무침', kcal: '35kcal', weight: '85g' },
    { source: require('../assets/image/food06.jpg'), name: '두부무침', kcal: '94kcal', weight: '85g' },
    { source: require('../assets/image/food07.jpg'), name: '제육볶음', kcal: '191kcal', weight: '105g' },
    { source: require('../assets/image/food08.jpg'), name: '돼지고기 편육', kcal: '116kcal', weight: '72g' },
    { source: require('../assets/image/food09.jpg'), name: '갈치조림', kcal: '123kcal', weight: '130g' },
    { source: require('../assets/image/food10.jpg'), name: '콩나물국', kcal: '40kcal', weight: '250g' },
    { source: require('../assets/image/food11.jpg'), name: '된장찌개', kcal: '139kcal', weight: '150g' },
    { source: require('../assets/image/food12.jpg'), name: '미역국', kcal: '55kcal', weight: '250g' },
  ];
  ...
  const checkAnswers = () => {
    ...
    if (isAnswer1Correct && isAnswer2Correct) {
      ...
      message = '1번 문제는 틀렸지만, 2번 문제는 맞았았습니다.';
    } else {

...
const Page48 = () => {
  ...
  const [userDailyCalorieAnswer2, setUserDailyCalorieAnswer2] = useState('');
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <View style={styles.inputContainer}>
          <View style={styles.inputRow}>
            ...
            <TextInput
              style={styles.input}
              value={userDailyCalorieAnswer2}
              onChangeText={setUserDailyCalorieAnswer2}
              placeholder="칼로리"
              keyboardType="numeric"
            />
          </View>
        ...
        <Button title="다음 페이지로" onPress={() => router.push('/Page49')} />
      </ScrollView>
